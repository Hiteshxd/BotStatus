...
def updateme(old, json_data, first_match, second_match):
    ...
    new_string += f"**Made with ❤️ via [BotStatus](https://github.com/Hiteshxd/botstatus)**. \n{second_match}" # self promotion is must ¯\_(ツ)_/¯
...
print('Mind joining @KxOfficial at Telegram and do follow me on github.com <HiteshXd>')
